...
/**
 * RoomBuilder — constructs the floor, ceiling, walls and door of the datacenter room.
...
export class RoomBuilder {
  ...
  static build(scene: THREE.Scene, maxAnisotropy: number): void {
    ...
    RoomBuilder.buildWalls(scene);
    RoomBuilder.buildDoor(scene);
  }

  // ─── Floor ───────────────────────────────────────────────────────────────

  private static buildFloor(scene: THREE.Scene, maxAnisotropy: number): void {
  ...
  private static buildCeiling(scene: THREE.Scene): void {
    const mesh = new THREE.Mesh(
      new THREE.PlaneGeometry(ROOM_WIDTH, ROOM_DEPTH),
      new THREE.MeshStandardMaterial({
  ...
  private static buildWalls(scene: THREE.Scene): void {
  ...
  private static buildDoor(scene: THREE.Scene): void {
