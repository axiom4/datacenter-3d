...
export function createFloorTexture(maxAnisotropy = 1): THREE.CanvasTexture {
...
export function createHazardStripeTexture(): THREE.CanvasTexture {
  ...
  return repeating(canvas, 2, 1);
}

export function createExitSignTexture(): THREE.CanvasTexture {
...
export function createServerFaceMaterial(): THREE.MeshStandardMaterial {
...
export function createServerRearMaterial(): THREE.MeshStandardMaterial {
  const [canvas, ctx] = makeCanvas(128, 128);
  ctx.fillStyle = '#111111';
  ctx.fillRect(0, 0, 128, 128);
  ctx.fillStyle = '#222222';
...
export function createRackFrameMaterial(): THREE.MeshStandardMaterial {
